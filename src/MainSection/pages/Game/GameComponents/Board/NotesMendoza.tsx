...
const NotesMendoza = () => {
  ...
  useEffect(() => {
    ...
    const song = new Audio(`https://res.cloudinary.com/dymptobl2/video/upload/v1734352721/Hnas_Mendoza_Sangurima_Cuitas_De_Amor_clpu3s.mp3`);
  ...
  return (
    <div>
      ...
      <PlayerSaveData score={score} songId={4} memberId={memberId} />
      {(!startGame)&&
...
NotesMendoza.defaultProps = {
  width: 1000,
  height: 1000,
};


export default NotesMendoza;
