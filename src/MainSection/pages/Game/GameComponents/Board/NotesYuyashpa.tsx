...
const NotesYuyashpa = () => {
  ...
  useEffect(() => {
    ...
    const song = new Audio(`https://res.cloudinary.com/dymptobl2/video/upload/v1734352737/yuyashpa_san_juanito_ecuador_rhe03z.mp3`);
  ...
  return (
    <div>
      ...
      <PlayerSaveData score={score} songId={6} memberId={memberId} />
      {(!startGame)&&
...
NotesYuyashpa.defaultProps = {
  width: 1000,
  height: 1000,
};


export default NotesYuyashpa;
