...
const NotesPasacalle = () => {
  ...
  useEffect(() => {
    ...
    const song = new Audio(`https://res.cloudinary.com/dymptobl2/video/upload/v1734352728/Ecuador_pasacalle_Por_algo_me_han_de_recordar_hihbid.mp3`);
  ...
  return (
    <div>
      ...
      <PlayerSaveData score={score} songId={5} memberId={memberId} />
      {(!startGame)&&
...
NotesPasacalle.defaultProps = {
  width: 1000,
  height: 1000,
};


export default NotesPasacalle;
