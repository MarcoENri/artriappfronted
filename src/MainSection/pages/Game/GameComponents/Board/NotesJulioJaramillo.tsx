...
const NotesJulioJaramillo = () => {
  ...
  useEffect(() => {
    ...
    const song = new Audio(`https://res.cloudinary.com/dymptobl2/video/upload/v1734353005/Julio_Jaramillo_Vol_1_Nuestro_Juramento_Fatalidad_Rondando_Tu_Esquina_Musica_Ecuatoriana_Ecuador_sgkkhn.mp3`);
  ...
  return (
    <div>
      ...
      <PlayerSaveData score={score} songId={8} memberId={memberId} />
      {(!startGame)&&
...
NotesJulioJaramillo.defaultProps = {
  width: 1000,
  height: 1000,
};


export default NotesJulioJaramillo;
