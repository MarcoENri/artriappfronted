...
const NotesTriosGarles = () => {
  ...
  useEffect(() => {
    ...
    const song = new Audio(`https://res.cloudinary.com/dymptobl2/video/upload/v1734352755/TRIO_LOS_GARLES_MOSAICO_VALSES_id9f4h.mp3`);
  ...
  return (
    <div>
      ...
      <PlayerSaveData score={score} songId={7} memberId={memberId} />
      {(!startGame)&&
...
NotesTriosGarles.defaultProps = {
  width: 1000,
  height: 1000,
};


export default NotesTriosGarles;
